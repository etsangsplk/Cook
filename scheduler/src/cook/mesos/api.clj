...
(defn read-groups-handler
  [conn framework-id task-constraints is-authorized-fn]
  (base-cook-handler
    {:allowed-methods [:get]
     :malformed? (fn [ctx]
                   (try
      ...
      (c-api/resource
       {:get {:summary "Returns info about a set of Jobs"
        ...
        :post {:summary "Schedules one or more jobs."
               ...
               :handler (create-jobs-handler conn framework-id task-constraints gpu-enabled? is-authorized-fn)}
     ...
     (c-api/context
      ...
      (c-api/resource
       {:get {:summary "Returns info about a set of groups"
              ...
              :handler (read-groups-handler conn framework-id task-constraints is-authorized-fn)}}))
